...
# # cache dir
# CACHE_DIR = '/tmp/terrormap_cache'
# os.makedirs(CACHE_DIR, exist_ok=True)

# # decay params (tunable)
# TIME_DECAY_DAYS = 30.0  # exponential temporal decay timescale
# SPATIAL_SIGMA_KM = 200.0  # spatial decay lengthscale in km
...
#         gdf_grid['risk'] = 0.0
#         out = gdf_grid.__geo_interface__
...
"""
Hawkes-like spatio-temporal predictor (heuristic PoC).
This implementation uses an exponential decay in time and distance and aggregates onto a lat/lon grid.
Returns GeoJSON FeatureCollection for client consumption.
"""
from datetime import datetime, timedelta
import os
import math
